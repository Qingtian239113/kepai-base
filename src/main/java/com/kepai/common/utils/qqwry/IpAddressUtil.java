package com.kepai.common.utils.qqwry;
...
public class IpAddressUtil {
    ...
    private static IpAddressUtil ipSeekerUtil;
     ...
     */
    private HashMap<String, IPLocation> cache = new HashMap<>();
     ...
     * @return
     */
    public static IpAddressUtil getIpAddress() {
        if (ipSeekerUtil == null) {
            synchronized (IpAddressUtil.class) {
                if (ipSeekerUtil == null) {
                    ipSeekerUtil = new IpAddressUtil();
                }
            }
        }
        return ipSeekerUtil;
    ...
    private IpAddressUtil() {
        try {
            ClassPathResource cpr = new ClassPathResource("qqwry/qqwry.dat");
            InputStream inputStream = cpr.getInputStream();
            File tempFile = File.createTempFile("qqwry", ".dat");
            try {
            ...
            buffer = new RandomAccessFile(tempFile, "r").getChannel().map(
